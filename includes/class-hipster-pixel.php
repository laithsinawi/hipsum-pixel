...
class Hipster_Pixel {
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-hipster-pixel-public.php';
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Hipster_Pixel_Public( $this->get_plugin_name(), $this->get_version() );
